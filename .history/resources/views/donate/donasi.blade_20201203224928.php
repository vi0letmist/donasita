                ...
                <div class="create-item padding-left-0 padding-right-0">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 center-all padding-top-20 padding-left-0 padding-right-0">
                        <div class="create-form">
                            <form id="create" method="POST" action="{{ route('donate.store') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    ...
                                    <fieldset>
                                        <input name="galadana_id" value="{{ $galadana->id }}" type="none" class="form-control" id="galadana_id">
                                    </fieldset>
