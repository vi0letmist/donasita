                ...
                <div class="donate-sidebar">
                    ...
                    <div class="donate-sidebar-body padding-top-20">
                        ...
                        <div class="sidebar-donate-header">
                            ...
                            <p class="padding-top-10">terkumpul dari <strong>267</strong> orang selama {{\Carbon\Carbon::createFromTimeStamp(strtotime($galadana->created_at))->locale('id')->longAbsoluteDiffForHumans()}}</p>
                        </div>
                    </div>
                </div>
