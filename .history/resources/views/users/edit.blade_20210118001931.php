                            ...
                            <div class="edit-item-body">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                        ...
                                        <fieldset>
                                            <input name="old_password" type="password" class="form-control" placeholder="Password Saat Ini" id="password">
                                        </fieldset>
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 form-group{{ $errors->has('password') ? ' has-danger' : '' }}">
                                        ...
                                        <fieldset>
                                            <input name="password" type="password" class="form-control" placeholder="Password Baru" id="password">
                                        </fieldset>
