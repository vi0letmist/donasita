                            ...
                            <div class="edit-body-body">
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group{{ $errors->has('judul') ? ' has-danger' : '' }}">
                                                <p>Judul:</p>
                                                <fieldset>
                                                    <input name="judul" type="text" class="form-control" id="judul" placeholder="{{$galadana->judul }}" value="{{ old('name', $galadana->judul) }}">
                                                </fieldset>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group{{ $errors->has('target_capaian') ? ' has-danger' : '' }}">
                                                <p>Target:</p>
                                                <fieldset>
                                                    <input name="target_capaian" type="text" class="form-control" id="target_capaian" placeholder="{{ $galadana->target_capaian }}" value="{{ old('name',$galadana->target_capaian) }}">
                                                </fieldset>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12 form-group{{ $errors->has('slug') ? ' has-danger' : '' }}">
                                                ...
                                                <fieldset>
                                                    <input name="slug" type="text" class="form-control" id="slug" placeholder="galangdana/{{ $galadana->slug }}" value="{{ old('name',$galadana->slug) }}">
                                                </fieldset>
                                                @include('alerts.feedback', ['field' => 'slug'])
                                            </div>
                                            <fieldset>
                                                <textarea type="hidden" name="cerita" value="{{ old('name',$galadana->cerita) }}" rows="6" class="cerita" id="cerita" placeholder="{{ $galadana->cerita}}"></textarea>
                                            </fieldset>
                                            <fieldset>
                                                <input name="gambar" type="hidden" class="form-control" id="gambar" value="{{ old('name',$galadana->gambar) }}">
                                            </fieldset>
                                    ...
                                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                        <fieldset>
                                            <textarea name="cerita" value="{{ old('name',$galadana->cerita) }}" rows="6" class="cerita" id="cerita" placeholder="{{ $galadana->cerita}}"></textarea>
                                        </fieldset>
