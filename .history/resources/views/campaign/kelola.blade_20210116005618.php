                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-9 sideRight">
                        ...
                        <div class="row kelolaAll">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s" onclick="location.href='/kelola/{{$g->slug}}/edit';" style="cursor: pointer;box-shadow: 0 2px 50px 0 rgba(0, 0, 0, 0.06);">
