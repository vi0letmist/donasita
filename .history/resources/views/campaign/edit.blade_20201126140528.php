...
<div class="container padding-top-60">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="row">
            ...
            <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapseExample" data-parent="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
