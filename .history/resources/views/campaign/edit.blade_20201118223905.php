                                    ...
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <p>Target:</p>
                                                <fieldset>
                                                    <input name="target" type="text" class="form-control" id="target" value="{{ old($galadana->target_capaian) }}" required="">
                                                </fieldset>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <p>Tautan penggalangan dana:</p>
                                                <fieldset>
                                                    <input name="link" type="text" class="form-control" id="link" value="{{ old($galadana->slug) }}" required="">
                                                </fieldset>
                                            </div>
