                ...
                <div class="admin-item-post">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12 admin-item">
                            <p>{{Auth::user()->name}} adalah yang mengelola penggalangan dana ini</p>
                        </div>
                    </div>
                    <div class="date-item">
            ...
            <div class="sidebar-donate-item" id="sidebar">
                <div class="sidebar-donate-header">
                    ...
                    <div class="progress-bar-xs progress">
                        <div class="progress-bar bg-success" role="progressbar" aria-valuenow="{{ $galadana->progres_capaian / $galadana->target_capaian * 100 }}" aria-valuemin="0" aria-valuemax="100" style="width: 20%;"></div>
                    </div>
