                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 center-all padding-left-0 padding-right-0">
                        ...
                        @csrf
                            ...
                            <div class="tab">
                                <div class="fit">
                                    ...
                                    <div class="file-upload">
                                        <input type="file" class="form-control btn btn-primary btn-sm" name="gambar" value="{{old('gambar')}}" onchange="readURL(this);" accept="image/*">
                            ...
                            <div class="tab">
                                <div class="fit">
                                    <div class="form-group{{ $errors->has('cerita') ? ' has-danger' : '' }}">
                                        <fieldset>
                                            <textarea oninput="this.className = ''" name="cerita" value="{{ old('cerita') }}" rows="6" class="form-control{{ $errors->has('cerita') ? ' is-invalid' : '' }}" id="cerita" placeholder="Your Message" required=""></textarea>
                                        </fieldset>
                                        @include('alerts.feedback', ['field' => 'judul'])
                                    </div>
                                </div>
                            ...
                            <div style="overflow:auto;">
                                ...
                                <button type="button" class="prev-button" id="prevBtn" onclick="nextPrev(-1)">Previous</button>
                                <button type="button" class="main-button" id="nextBtn" onclick="nextPrev(1)">Next</button>
                                </div>
                            </div>
