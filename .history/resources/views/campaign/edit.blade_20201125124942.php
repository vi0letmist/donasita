                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12 form-group{{ $errors->has('slug') ? ' has-danger' : '' }}">
                                                <p>Tautan penggalangan dana:</p>
                                                <p style="color:#353535;font-weight:400;"><strong>gofundme.com/f/i-didn039t-no</strong><br>
                                                This link can only be changed once. Changing your link does not break your previous link.</p>
                                                <fieldset>
