        ...
        <div class="modal-content">
            ...
            <div class="scroll-area-lg">
                <div class="modal-body scrollbar-container ps--active-y">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <input type="text" value="Hello World" id="salinLink">
                        <div class="tooltip">
                        <button type="button" class="btn seeall-button" onclick="myFunction()" onmouseout="outFunc()">
                        <span class="tooltiptext" id="salinTooltip">Copy to clipboard</span>
                        Copy text
                        </button>
                        </div>
                    </div>
...
function myFunction() {
  ...
  var tooltip = document.getElementById("salinTooltip");
