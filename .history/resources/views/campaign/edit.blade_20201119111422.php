                                ...
                                <div class="tab-content" id="myTabContent">
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <p>Judul:</p>
                                                <fieldset>
                                                    <input name="judul" type="text" class="form-control" id="judul" placeholder="{{ $galadana->judul }}" value="{{ old($galadana->judul) }}">
                                                </fieldset>
                                            ...
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <p>Target:</p>
                                                <fieldset>
                                                    <input name="target" type="text" class="form-control" id="target" placeholder="{{ $galadana->target_capaian }}" value="{{ old($galadana->target_capaian) }}">
                                                </fieldset>
                                            </div>
                                            <div class="col-lg-6 col-md-6 col-sm-12">
                                                <p>Tautan penggalangan dana:</p>
                                                <fieldset>
                                                    <input name="slug" type="text" class="form-control" id="slug" placeholder="galangdana/{{ $galadana->slug }}" value="{{ old($galadana->slug) }}">
                                                </fieldset>
                                            </div>
                                    ...
                                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                        <div class="file-upload">
                                            <input style="padding-top: 10px;" type="file" class="form-control btn btn-sm" name="gambar" value="{{old('$galadana->gambar')}}" onchange="readURL(this);" accept="image/*">
                                    ...
                                    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                                        <fieldset>
                                            <textarea name="cerita" value="{{ old('$galadana->cerita') }}" rows="6" class="cerita" id="cerita" placeholder="{{ old('$galadana->cerita') }}"></textarea>
                                        </fieldset>
