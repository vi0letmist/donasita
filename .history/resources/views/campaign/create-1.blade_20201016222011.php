                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 center-all padding-top-20 padding-left-0 padding-right-0">
                        <div class="create-form">
                            <form id="regForm" action="/action_page.php">
                                ...
                                <div class="tab">
                                    <fieldset>
                                        <textarea oninput="this.className = ''" rows="6" class="form-control" id="cerita" placeholder="Your Message" required=""></textarea>
                                    </fieldset>
                                </div>
                                ...
                                <ul id="probar">
                                    ...
                                    <li class="step" id="cerita"><strong>Personal</strong></li>
