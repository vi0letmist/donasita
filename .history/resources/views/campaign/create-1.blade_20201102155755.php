                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 center-all padding-left-0 padding-right-0">
                        <div class="create-form">
                            ...
                            @csrf
                                ...
                                <div class="tab">
                                        ...
                                        <div class="form-group mb-3">
                                            <div class="input-group input-group-alternative">
                                                <div class="input-group-prepend">
                                                    ...
                                                    <fieldset>
                                                        <input oninput="this.className = ''" name="target" value="{{ old('target') }}" type="text" class="form-control" id="target" placeholder="10.000.000" required="" autofocus>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="fit">
                                        <div class="form-group{{ $errors->has('judul') ? ' has-danger' : '' }}">
                                            ...
                                            <fieldset>
                                                <input oninput="this.className = ''" name="judul" value="{{ old('judul') }}" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" id="judul" placeholder="{{ __('Judul Penggalangan Dana') }}" required="">
                                            </fieldset>
                                ...
                                <div class="tab">
                                    <div class="fit">
                                        <h5 class="padding-top-20">aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
                                            aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
                                            aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa
                                        </h5>
                                        <input type="file" class="form-control btn btn-primary btn-sm" name="gambar" value="{{old('gambar')}}">
                                        <div class="file-upload">
                                            <button class="file-upload-btn" type="button" name="gambar" onclick="$('.file-upload-input').trigger( 'click' )">Add Image</button>
                                            <div class="image-upload-wrap">
                                                <input oninput="this.className = ''" class="file-upload-input" type='file' value="{{ old('gambar') }}" onchange="readURL(this);" accept="image/*" />
                                                <div class="drag-text">
                                        ...
                                        <small class="form-text text-danger">{{$errors->first('gambar')}} </small>
                                        @endif
                                    </div>
                                </div>
                                <div class="tab">
                                    <div class="fit">
                                        <fieldset>
                                            <textarea oninput="this.className = ''" name="cerita" value="{{ old('cerita') }}" rows="6" class="form-control" id="cerita" placeholder="Your Message" required=""></textarea>
                                        </fieldset>
                                        @if ($errors->has('cerita'))
                                        <small class="form-text text-danger">{{$errors->first('cerita')}} </small>
                                        @endif
                                    </div>
                                </div>
                                <div class="tab">
