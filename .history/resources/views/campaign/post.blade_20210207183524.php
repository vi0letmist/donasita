                ...
                <div class="modal-body scrollbar-container ps--active-y">
                    ...
                    <div id="social-links">
                        <ul>
                            ...
                            <div class="fb-svg-container fb-logo">
                            </div>
                            facebook
                            </li>
                            </a>
                            ...
                            <img src="{{ asset('assets') }}/svg/twitter-brands.svg" alt="My SVG Icon">
                            facebook
                            </li>
                            </a>
                            </li>
                            <li><a target="_blank" href="https://www.reddit.com/submit?title=Default+share+text&amp;url=http://localhost:8000/g/vaksin-masal-covid-19" class="social-button " id="" title=""><span class="fab fa-reddit"></span></a>
                            </li>
                            <li><a target="_blank" href="https://telegram.me/share/url?url=http://localhost:8000/g/vaksin-masal-covid-19&amp;text=Default+share+text" class="social-button " id="" title=""><span class="fab fa-telegram"></span></a>
                            </li>
                            <li><a target="_blank" href="https://wa.me/?text=http://localhost:8000/g/vaksin-masal-covid-19" class="social-button " id="" title=""><span class="fab fa-whatsapp"></span></a>
                            </li>
                        </ul>
                    </div>
                </div>
