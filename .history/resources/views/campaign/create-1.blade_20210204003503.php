                            ...
                            <div class="tab">
                                    ...
                                    <div class="form-group mb-3 {{ $errors->has('target_capaian') ? ' has-danger' : '' }}">
                                        <div class="input-group input-group-alternative">
                                            <div class="input-group-prepend">
                                                ...
                                                <fieldset>
                                                    <input oninput="this.className = ''" name="target_capaian" value="{{ number_format('target_capaian') }}" type="text" class="form-control{{ $errors->has('target_capaian') ? ' is-invalid' : '' }}" id="target_capaian" placeholder="10.000.000" required="" autofocus>
                                                </fieldset>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="fit">
                                    ...
                                    <div class="form-group{{ $errors->has('kategori') ? ' has-danger' : '' }}">
                                            <label class="form-control-label" for="input-penerbit">{{ __('Kategori *  ') }}</label><br>
                                                <select name="kategori" class="form-control{{ $errors->has('kategori') ? ' has-danger' : '' }}" required="">
