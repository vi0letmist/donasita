...
<div class="container padding-top-60">
    <div class="col-lg-12 col-md-12 col-sm-12">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="create-item">
                    <form id="createForm" action="/action_page.php">
                        <h1>Register:</h1>
                        <!-- One "tab" for each step in the form: -->
                        <div class="tab">Name:
                        <div class="row">
                                        ...
                                        <div class="form-group mb-3">
                                            <div class="input-group input-group-alternative">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">Rp.</span>
                                                    <fieldset>
                                                        <input name="target" type="text" class="form-control" id="target" placeholder="10.000.000" required="" autofocus oninput="this.className = ''" name="fname">
                                                    </fieldset>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 padding-left-4 padding-right-4">
                                        <fieldset>
                                            <input name="judul" type="text" class="form-control" id="judul" placeholder="Judul Penggalangan Dana" required="" oninput="this.className = ''" name="fname">
                                        </fieldset>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 padding-left-4 padding-right-4">
                                        <fieldset>
