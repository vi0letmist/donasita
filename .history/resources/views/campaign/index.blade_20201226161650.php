...
@section('content')
    ...
    <section class="section padding-bottom-60 colored">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 col-12 kategoriBox" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s" data-location="/galadana/{{$k->slug}}">
    ...
    <!-- ***** Discover near End ***** -->
 <script>
     window.location = $(".kategoriBox").data("location");
 </script>
   @endsection