        ...
        <div class="col-lg-8 col-md-12 col-sm-12" id="item-post">
            <div class="item-post">
                <div class="post-pict-item">
                    <img src="{{URL::asset('/images/' . $b->gambar)}}" class="rounded img-fluid d-block mx-auto" alt="">
                </div>
                <div class="admin-item-post">
                    <div class="row">
                        <div class="col-lg-2 col-md-2 col-sm-12" style="margin-bottom:10px;">
                            <img src="{{ $galadana->gambar }}" alt="">
                        </div>
                        <div class="col-lg-10 col-md-10 col-sm-12 admin-item">
                            <p>{{Auth::user()->nama}} adalah yang mengelola penggalangan dana ini</p>
                        </div>
                    </div>
                    <div class="date-item">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2 col-md-4 col-sm-12 post-pict-item padding-bottom-40 padding-top-20">
