                                    ...
                                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <p>Judul:</p>
                                                <fieldset>
                                                    <input name="judul" type="text" class="form-control" id="judul" value="{{ old($galadana->judul) }}" required="">
                                                </fieldset>
                                            </div>
                                            <div class="col-lg-6">
                                                <p>Target:</p>
                                                <fieldset>
                                                    <input name="target" type="text" class="form-control" id="target" placeholder="Target" value="{{ old($galadana->target_capaian) }}" required="">
                                                </fieldset>
                                            </div>
                                            <div class="col-lg-6">
                                                <p>Tautan penggalangan dana:</p>
                                                <fieldset>
                                                    <input name="link" type="text" class="form-control" id="link" placeholder="galangdana/{{ old($galadana->slug) }}" value="{{ old($galadana->slug) }}" required="">
                                                </fieldset>
                                            </div>
