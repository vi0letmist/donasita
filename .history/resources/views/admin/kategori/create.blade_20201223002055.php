                    ...
                    <div class="card-body"><h5 class="card-title">Control Types</h5>
                        ...
                        @csrf
                            ...
                            <div class="form-group{{ $errors->has('nama') ? ' has-danger' : '' }} position-relative">
                                ...
                                <fieldset>
                                    <input oninput="this.className = ''" name="nama" id="nama" placeholder="Nama Kategori" type="text" class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}" value="{{old('nama)}}" required="">
                                </fieldset>
