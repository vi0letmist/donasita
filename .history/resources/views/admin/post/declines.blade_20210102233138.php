                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('manajemen-post.edit', $g->slug)}}">
                                            <button class="mr-2 btn-icon btn-icon-only btn btn-sm btn-success"><i class="fa fa-note btn-icon-wrapper"> </i></button>
                                        </a>
                                        <button class="mr-2 btn-icon btn-icon-only btn btn-sm btn-info"><i class="fa fa-info btn-icon-wrapper"> </i></button>
