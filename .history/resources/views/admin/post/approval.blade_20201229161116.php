        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s">
                <div class="features-populer-item">
                    ...
                    <a class="mr-2 btn-icon btn-icon-only btn btn-success btn-blc"><i class="pe-7s-check btn-icon-wrapper"> </i></a>
                    ...
                    <a class="mr-2 btn-icon btn-icon-only btn btn-outline-danger btn-blc"><i class="pe-7s-close btn-icon-wrapper"> </i></a>
