                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-scroll-reveal="enter bottom move 50px over 0.6s after 0.2s" onclick="location.href='/g/{{$l->slug}}';" style="cursor: pointer;">
                            <div class="features-populer-item">
                                ...
                                <div class="donateprog">
                                    <p><b>Rp. {{ number_format($l->progres_capaian, 2) }}</b> dari Rp. {{ number_format($l->target_capaian, 2) }}</p>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <table id="myTable" class="mb-0 table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    <input type="hidden" class="deleteGaladanaId" value="">
                                    <th scope="row">1</th>
                                    <td>a</td>
                                    <td>asasas</td>
                                    <td>sdffdf</td>
