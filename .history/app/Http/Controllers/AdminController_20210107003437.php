    ...
    public function managepost()
    {
        ...
        if(request()->ajax()) {
            ...
            ->addColumn('action', function($galadana){
                ...
                $btn = $btn.'<button class="mr-2 btn-icon btn-icon-only btn btn-sm btn-outline-danger deleteGaladana" data-id="'.$galadana->id.'"><i class="pe-7s-trash btn-icon-wrapper"> </i></button>';
                return $btn;
            })
