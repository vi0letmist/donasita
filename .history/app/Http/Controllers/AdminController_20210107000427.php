    ...
    public function managepost()
    {
        ...
        if(request()->ajax()) {
            ...
            ->addColumn('action', function($galadana){
                $btn2 = '<a href="route(manajemen-post.edit, '.$galadana->slug.')">
                <button class="mr-2 btn-icon btn-icon-only btn btn-sm btn-success"><i class="pe-7s-note btn-icon-wrapper"> </i></button>
                </a>';
                $btn1 = '<button class="mr-2 btn-icon btn-icon-only btn btn-sm btn-info"><i class="pe-7s-info btn-icon-wrapper"> </i></button>';
                $btn = '<button class="mr-2 btn-icon btn-icon-only btn btn-sm btn-outline-danger deleteGaladana"><i class="pe-7s-trash btn-icon-wrapper"> </i></button>';
