...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('manajemen-post/{slug}/ubah', 'KategoriController@edit')->name('manajemen-kategori.edit');
    Route::put('manajemen-kategori/{slug}', ['as' => 'manajemen-kategori.update', 'uses' => 'KategoriController@update']);
    Route::get('manajemen-kategori/{slug}/lihat', 'KategoriController@show')->name('kategori.show','[a-z]+');
