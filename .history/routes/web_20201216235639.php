...
Route::post('/galadana/load_komen/{id}', 'CampaignController@load_data')->name('loadmore.load_data');
...
Route::get('/loadmore/{slug}', 'CampaignController@index')->name('loadmore', '[a-z]+');
Route::post('/loadmore/load_data/{id}', 'CampaignController@load_data')->name('loadmore.load_data');
