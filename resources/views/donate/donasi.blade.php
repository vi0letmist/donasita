...
@section('title')
    <title>Donasi untuk {{$galadana->judul}}</title>
@endsection
@section('content')
<style>
    html,body{
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 padding-left-4 padding-right-1">
                                        <div class="form-group{{ $errors->has('nama') ? ' has-danger' : '' }}">
                                            <fieldset>
                                                <input name="nama" value="{{Auth::user()->name}}" type="text" class="form-control{{ $errors->has('nama') ? ' is-invalid' : '' }}" id="nama" placeholder="{{Auth::user()->name}}" required="">
                                            </fieldset>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 padding-left-1 padding-right-4">
                                        <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                            <fieldset>
                                                <input name="email" value="{{Auth::user()->email}}" type="text" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" id="email" placeholder="{{Auth::user()->email}}" required="">
                                            </fieldset>
